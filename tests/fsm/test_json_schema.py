...
def test_int_range_unconstrained():
    ...
    # caveat: json_schema.INTEGER allows -0, we can remove this functionality safely at any time
...
@pytest.mark.parametrize(
    "min_len,max_len,safe_subset,expected_max",
    [
...
def test_get_str_pattern(min_len, max_len, safe_subset, expected_max):
