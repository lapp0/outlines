...
Outlines supports a wide variety of inference engines and model weight types. More details on different models can be found in the [Outlines Models](./reference/models/index.md) documentation page.
...
([Outlines Structured Generation Full Documentation](./reference/generation/index.md))
